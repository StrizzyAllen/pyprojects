...
def generate_dice_faces_diagram(dice_values):
    """Return an ASCII diagram of dices from 'dice_values'.
...
def parse_input(input_string):
    """Return 'input_string' is an integer number between 1 and 6.
    
    Check if 'input)string' is an integer number between 1 and 6.
